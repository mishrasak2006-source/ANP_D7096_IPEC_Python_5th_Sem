...
A government tax portal calculates tax based on the
following conditions:

• Income up to ₹5,00,000      -> No Tax
• ₹5,00,001 to ₹10,00,000     -> 10% Tax
• ₹10,00,001 to ₹20,00,000    -> 20% Tax
• Above ₹20,00,000            -> 30% Tax

Additional Benefits:
• Senior Citizen (Age >= 60) -> 5% rebate on tax
• Female Taxpayer            -> 2% rebate on tax

Write a Python program to calculate the final
tax amount payable.
-----------------------------------------------------------
Sample Input
